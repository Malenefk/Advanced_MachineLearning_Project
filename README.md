...
<img width="420" height="300" alt="turbulence_animation_q_sp50" src="https://github.com/user-attachments/assets/f2b69ef7-0dce-48ec-9ccb-ac9126c44ed3" />    <img width="420" height="300" alt="turbulence_animation_psi_sp50" src="https://github.com/user-attachments/assets/cbaaecec-f263-4da2-84d1-d2b4c3dface9" />

The two animations show $\psi$ (stramfunction) and $q$ (potential vorticity) and how their dynamics vary with time. The animations are plotted directly from the dataset used as input for training the ML models. 
...
- **Code**
  ...
  - *MovingAvg_baseline:*
  - The moving average can be run by the CLI code "python moving_average_baseline.py". This uses the same pre-processed data file "t30.nc" and is also "plug and play" as it is in the folder.
